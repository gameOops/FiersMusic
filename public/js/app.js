...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    create: function create() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/addNew', data).then(function (_ref) {
        var data = _ref.data;
        console.log(data);
      });
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadPlaylist: function loadPlaylist() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/playlist', data).then(function (_ref) {
        var data = _ref.data;
        _this.album = data[0];
        songs = data[0]['tracks'];
        _this.author = data[0]['author'];
        _this.year = data[0]['year'];
        _this.albName = data[0]['name'];
        _this.idAlbum = data[0]['id'];
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/selectAll', data2).then(function (_ref2) {
          var data = _ref2.data;
          console.log(data);
          _this.albumAll = data;
        });
        document.title = 'Spotify — ' + _this.album.name;
      });
    },
    handleFileUpload: function handleFileUpload() {
      this.file = this.$refs.file.files[0];
    ...
    create: function create() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/addNewTrack', data).then(function (_ref3) {
        var data = _ref3.data;
      });
    },
    getAll: function getAll() {},
    showPlay: function showPlay(id) {
      if (this.playing - 1 != id) {
        $('#track_' + (id + 1)).hide();
        $('#play_' + (id + 1)).show();
      }
    },
    hidePlay: function hidePlay(id) {
      if (this.playing - 1 != id) {
        $('#track_' + (id + 1)).show();
        $('#play_' + (id + 1)).hide();
      }
    },
    play: function play(src, name, author, id) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/user', data).then(function (_ref) {
      var data = _ref.data;
      _this.user = data;
      console.log(data);
    });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadArtist: function loadArtist() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/selectArtist', data).then(function (_ref) {
        var data = _ref.data;
        console.log(data);
        _this.artist = data;
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/selectTracks', data3).then(function (_ref3) {
          var data = _ref3.data;
          console.log(data);
          _this.tracks = data;
        });
    ...
    play: function play(src, name, author, img) {
      $('#cur_name').text(name);
      $('#cur_auth').text(author);
      $('#audioplayer').attr('src', '/audio/' + src);
      $('#audioplayer').trigger("play");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/login', data).then(function (_ref2) {
        var data = _ref2.data;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadPlaylist: function loadPlaylist() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/download', data).then(function (_ref) {
        var data = _ref.data;
        console.log(data);
        _this.albums = data;
      });
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/allPlay', data).then(function (_ref2) {
        var data = _ref2.data;
        console.log(data);
        _this.albumsAll = data;
      });
    }
  },
  mounted: function mounted() {
  ...
  methods: {
    search: function search() {
      ...
      if (this.searcher) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/searchTrack', data).then(function (_ref) {
          var data = _ref.data;
          console.log(data);
          _this.tracks = data;
        });
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/searchAlbum', data).then(function (_ref2) {
          var data = _ref2.data;
          console.log(data);
          _this.albumAll = data;
        });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadArtist: function loadArtist() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/userId', data).then(function (_ref) {
        var data = _ref.data;
        console.log(data);
        _this.artist = data;
        _this.name = data['name'];
...
var render = function() {
  ...
  return _c("div", { staticStyle: { "padding-top": "44px" } }, [
    _c("div", { staticClass: "addAlbum" }, [
      _c("div", { staticClass: "register_form" }, [
        _c("h4", { staticStyle: { "font-weight": "bold" } }, [
          _vm._v("Создание альбома")
        ]),
        _vm._v(" "),
        _c("br"),
        _vm._v(" "),
        _c("div", { staticClass: "mb-3" }, [
          ...
          _c("input", {
            ...
            attrs: { type: "email", placeholder: "Введите название релиза" },
        ...
        _c("div", { staticClass: "mb-3" }, [
          ...
          _c("input", {
            ...
            staticClass: "form-control",
            attrs: { type: "text", placeholder: "Введите автора" },
        ...
        _c(
          "button",
          {
            ...
            staticStyle: { "background-color": "#1db954" },
            attrs: { type: "submit" },
            on: { click: _vm.create }
          },
          [_vm._v("Регистрация")]
  ...
  function() {
    ...
    return _c("div", { staticClass: "mb-3 form-check" }, [
      ...
      _c(
        ...
        [_vm._v("Согласен с условиями использования Spotify")]
      )
    ])
  }
]
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticStyle: { "padding-top": "35px" } }, [
    _c(
      "div",
      {
    ...
    _vm._v(" "),
    _c("div", { staticClass: "album_header" }, [
      _c("div", { staticClass: "album_img" }, [
        _c("img", { attrs: { src: _vm.album.image, alt: "" } })
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "album_info" }, [
        _c("div", { staticClass: "stat" }, [
          _vm._v("\n                Альбом\n            ")
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "album_name" }, [
          _vm._v(
        ...
        _c(
          "div",
          { staticClass: "album_author" },
          [
            _c(
              "router-link",
              {
                attrs: {
                  to: { name: "artist", params: { id: _vm.album.author } }
                }
              },
              [
                _vm._v(
                  "\n                    " +
                    _vm._s(_vm.album.author) +
                    "\n                "
                )
              ]
            )
    ...
    _vm._v(" "),
    _c("div", { staticClass: "album_tracks" }, [
      _c("table", { staticClass: "table table-borderless" }, [
        _vm._m(3),
        _vm._v(" "),
        _c(
          "tbody",
          _vm._l(_vm.album.tracks, function(item, key) {
            return _c(
              "tr",
              {
                attrs: { id: "tr_" + (key + 1) },
                on: {
                  mouseover: function($event) {
                    return _vm.showPlay(key)
                  },
                  mouseleave: function($event) {
                    return _vm.hidePlay(key)
                  },
                  click: function($event) {
                    return _vm.play(item.src, item.name, item.author, key + 1)
                  }
                }
              },
              [
                _c(
                  "th",
                  { staticStyle: { width: "40px" }, attrs: { scope: "row" } },
                  [
                    _c(
                      "p",
                      {
                        staticStyle: { "margin-bottom": "0px" },
                        attrs: { id: "track_" + (key + 1) }
                      },
                      [_vm._v(_vm._s(key + 1))]
                    ),
                    _vm._v(" "),
                ...
                _c(
                  "td",
                  { staticStyle: { width: "88%", "font-weight": "bold" } },
                  [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "music_row" }, [
      _c("h4", { staticClass: "row_title" }, [
        _vm._v(_vm._s(_vm.author) + ": другие альбомы")
      ]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "row_cont" },
        _vm._l(_vm.albumAll, function(item) {
          return _c(
            "div",
            { staticClass: "music_card" },
            [
              _c(
                "router-link",
                { attrs: { to: { name: "album", params: { id: item.id } } } },
                [
                  _c("div", { staticClass: "card_img" }, [
                    ...
                    _c(
                      "button",
                      {
                        staticClass: "card_play",
                        attrs: { "aria-label": "Слушать" }
                      },
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "card_author" }, [
                    _vm._v(
                      "\n                        " +
                        _vm._s(item.author) +
                        "\n                    "
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      "thead",
      { staticStyle: { "border-bottom": "1px solid", color: "#b3b3b3" } },
      [
        _c("tr", [
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("audio", { attrs: { id: "audioplayer", src: "" } }),
    _vm._v(" "),
    _c("div", { staticClass: "page" }, [
      _c("div", { staticClass: "nav_menu" }, [
        _c("div", { staticClass: "logo" }, [
          _c("div", { attrs: { id: "logo" } }, [
            _c(
              "svg",
              {
                staticClass: "spotify-logo--text",
                attrs: { viewBox: "0 0 1134 340" }
              },
              [
                _c("title", [_vm._v("Spotify")]),
                _c("path", {
                  attrs: {
                    fill: "currentColor",
                    d:
        ...
        _c("div", { staticClass: "menu" }, [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "playlist_create" }, [
            _c("div", { staticClass: "creare_pl" }, [
              _c(
                "svg",
                {
                  staticClass: "Svg-sc__sc-1bi12j5-0 hPiOwj",
                  attrs: {
                    role: "img",
                    height: "12",
                    width: "12",
                ...
                [
                  _c("path", { attrs: { d: "M14 7H9V2H7v5H2v2h5v5h2V9h5z" } }),
                  _c("path", { attrs: { fill: "none", d: "M0 0h16v16H0z" } })
                ]
              )
            ]),
            _vm._v(" "),
            _c("p", [_vm._v("Создать плейлист")])
          ]),
          _vm._v(" "),
          _c("hr"),
          _vm._v(" "),
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "page_header" }, [
            _c("div", { staticClass: "page_control" }, [
              _c(
                "div",
                {
                  staticClass: "history_btn",
                  on: {
                    click: function($event) {
            ...
            _vm._v(" "),
            _c("div", { staticClass: "min_name" }),
            _vm._v(" "),
            this.token
              ? _c(
                  "div",
                  { staticClass: "profile", attrs: { onclick: "menu()" } },
                  [
                    _c("div", { staticClass: "prof_img" }, [
                      _c("img", { attrs: { src: _vm.user["image"], alt: "" } })
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "prof_name" }, [
                      _vm._v(
                        "\n                       " +
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "prof_arrow" }, [
                      _c(
                        "svg",
                        {
                          staticClass:
                            "Svg-sc__sc-1bi12j5-0 hPiOwj f6406a56d35aea2a3598f6f270ef156c-scss",
                          attrs: {
                            role: "img",
                            height: "16",
                            width: "16",
                        ...
                        [_c("path", { attrs: { d: "M3 6l5 5.794L13 6z" } })]
                      )
                    ]),
                    _vm._v(" "),
                    _c(
              ...
              : _c("div", { staticClass: "login" }, [
                  ...
                  _c(
                    "div",
                    { staticClass: "login_btnq" },
                    [
                      _c(
                        "router-link",
                        {
                          staticStyle: { color: "#181818!important" },
                          attrs: { to: { name: "auth" } }
                        },
                        [_vm._v("Войти")]
                      )
      ...
      _c("div", { staticClass: "player" }, [
        _vm._m(3),
        _vm._v(" "),
        _c("div", { staticClass: "current_control" }, [
          _c("div", { staticClass: "current_btns" }, [
            _c(
              "svg",
              {
                staticClass: "Svg-sc__sc-1bi12j5-0 hPiOwj",
            ...
            _c(
              ...
              [
                _c("path", {
                  attrs: { d: "M13 2.5L5 7.119V3H3v10h2V8.881l8 4.619z" }
                })
              ]
            ),
            _vm._v(" "),
            _c("i", {
              staticClass: "bi bi-play-circle-fill",
              staticStyle: { "font-size": "26px", color: "white" },
              attrs: { id: "play_btn", onclick: "play()" }
            }),
            _vm._v(" "),
            _c(
              "svg",
              ...
              [
                _c("path", {
                  attrs: { d: "M11 3v4.119L3 2.5v11l8-4.619V13h2V3z" }
                })
              ]
            ),
            _vm._v(" "),
        ...
        _vm._v(" "),
        _c("div", { staticClass: "current_vol" }, [
          _c("div", { staticClass: "ico_vol" }, [
            _c(
              "svg",
              {
                staticClass: "Svg-sc__sc-1bi12j5-0 hPiOwj",
                staticStyle: { fill: "white", "margin-right": "15px" },
                attrs: {
                  role: "presentation",
                  height: "16",
                  width: "16",
              ...
              [
                _c("path", {
                  attrs: {
                    d:
                      "M12.945 1.379l-.652.763c1.577 1.462 2.57 3.544 2.57 5.858s-.994 4.396-2.57 5.858l.651.763a8.966 8.966 0 00.001-13.242zm-2.272 2.66l-.651.763a4.484 4.484 0 01-.001 6.397l.651.763c1.04-1 1.691-2.404 1.691-3.961s-.65-2.962-1.69-3.962zM0 5v6h2.804L8 14V2L2.804 5H0zm7-1.268v8.536L3.072 10H1V6h2.072L7 3.732z"
                  }
                })
              ]
            )
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "playlists" }, [
      _c("a", { attrs: { href: "" } }, [_vm._v("Плейлист")]),
      _vm._v(" "),
      _c("a", { attrs: { href: "" } }, [_vm._v("Плейлист2")]),
      _vm._v(" "),
      _c("a", { attrs: { href: "" } }, [_vm._v("Плейлист3")]),
      _vm._v(" "),
      _c("a", { attrs: { href: "" } }, [_vm._v("Плейлист4")]),
      _vm._v(" "),
      _c("a", { attrs: { href: "" } }, [_vm._v("Плейлист5")])
    ])
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "player_current" }, [
      _c("div", { staticClass: "current_img" }, [
        _c("img", {
          attrs: {
            id: "cur_img",
            src:
              "https://i.scdn.co/image/ab67616d0000b273b6f2c7b3d80941aeaf8c0046",
            alt: ""
          }
        })
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "current_name" }, [
        _c(
          "div",
          { staticStyle: { "font-weight": "bold" }, attrs: { id: "cur_name" } },
          [_vm._v("\n                        4(интро)\n                    ")]
        ),
        _vm._v(" "),
        _c(
          "div",
          { staticStyle: { "font-size": "14px" }, attrs: { id: "cur_auth" } },
          [_vm._v("\n                        Джизус\n                    ")]
        )
      ]),
      _vm._v(" "),
      _c("div", [
        _c("i", {
          ...
          staticStyle: { color: "white", "margin-left": "15px" }
        })
      ])
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "current_time" }, [
      _c("div", { staticClass: "timeline" }, [
        _c("span", { attrs: { id: "cur_t" } }, [_vm._v("0:00")]),
        _vm._v(" "),
        _c("input", {
          attrs: {
            id: "audio_line",
            onchange:
              "document.getElementById('audioplayer').currentTime = $('#audio_line').val()",
            min: "0",
            max: "100",
            type: "range"
          }
        ...
        _vm._v(" "),
        _c("span", { attrs: { id: "dur_t" } }, [_vm._v("0:00")])
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "vol" }, [
      _c("input", {
        attrs: {
          ...
          step: "0.01",
          onchange:
            "document.getElementById('audioplayer').volume = $('#vol_inp').val()",
          type: "range"
        }
      })
    ])
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("div", { staticClass: "artist_bg" }, [
      _c("div", { staticClass: "artist_info" }, [
        _c("div", { staticClass: "verify" }, [
          _c(
            ...
            [
              ...
              _c("path", {
                attrs: {
                  d:
                    "M16.8637 7.41226l-6.6435 7.77824-2.80421-3.2842-.4935.5775 3.29771 3.8617 7.2135-8.44649-.57-.48675z",
                  fill: "#fff"
                }
              })
            ]
          ...
          _vm._v(" "),
          _c("p", [_vm._v("Подтвержденный артист")])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "artist_name" }, [
          _vm._v(
            "\n                " + _vm._s(_vm.artist["name"]) + "\n            "
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "listens" }, [
          _vm._v(
    ...
    _vm._v(" "),
    _c("div", { staticClass: "album_tracks" }, [
      _c("h4", { staticClass: "row_title", staticStyle: { color: "white" } }, [
        _vm._v("Популярные треки")
      ]),
      _vm._v(" "),
      _c("table", { staticClass: "table table-borderless" }, [
        _c(
          "tbody",
          _vm._l(_vm.tracks, function(item, key) {
            return _c(
              "tr",
              {
                on: {
              ...
              [
                ...
                _c("td", [
                  _c("img", {
                    ...
                    attrs: { src: item["playlist"]["image"], alt: "" }
                  })
                ]),
                _vm._v(" "),
                _c(
    ...
    _vm._v(" "),
    _c("div", { staticClass: "artist_content" }, [
      _c("div", { staticClass: "music_row" }, [
        _c("h4", { staticClass: "row_title" }, [_vm._v("Альбомы исполнителя")]),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "row_cont" },
...
var render = function() {
  ...
  return _c(
    "div",
    { staticStyle: { "padding-top": "44px", display: "flex" } },
    [
      _c("div", { staticClass: "register_form" }, [
        _c("h4", { staticStyle: { "font-weight": "bold" } }, [
          _vm._v("Регистрация")
        ...
        _c("div", { staticClass: "mb-3" }, [
          _c(
            ...
            [_vm._v("Введите адрес электронной почты")]
          ),
          _vm._v(" "),
          _c("input", {
            directives: [
        ...
        _c("div", { staticClass: "mb-3" }, [
          _c(
            ...
            [_vm._v("Подтвердите адрес электронной почты\n                ")]
          ),
          _vm._v(" "),
          _c("input", {
            directives: [
            ...
            domProps: { value: _vm.regEmail2 },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.regEmail2 = $event.target.value
              }
            }
          })
        ]),
        ...
        _c("div", { staticClass: "mb-3" }, [
          ...
          _c("input", {
            ...
            staticClass: "form-control",
            attrs: { type: "password", placeholder: "Придумайте пароль" },
            domProps: { value: _vm.regPass },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.regPass = $event.target.value
              }
            }
          })
        ]),
        ...
        _c("div", { staticClass: "mb-3" }, [
          ...
          _c("input", {
            ...
            staticClass: "form-control",
            attrs: { type: "text", placeholder: "Укажите свое имя" },
        ...
        _c("div", { staticClass: "mb-3" }, [
          ...
          _c("input", {
            ...
            staticClass: "form-control",
            attrs: { type: "date", placeholder: "Укажите свое имя" },
            domProps: { value: _vm.regDate },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.regDate = $event.target.value
              }
            }
          })
        ]),
      ...
      _c("div", { staticClass: "register_form" }, [
        ...
        _c("div", { staticClass: "mb-3" }, [
          ...
          _c("input", {
            ...
            domProps: { value: _vm.authPass },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.authPass = $event.target.value
              }
            }
          })
        ]),
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticStyle: { "padding-top": "60px" } }, [
    _vm._m(0),
    _vm._v(" "),
    _c("div", { staticClass: "music_row" }, [
      _c("h4", { staticClass: "row_title" }, [_vm._v("Слушаем дальше?")]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "row_cont" },
        _vm._l(_vm.albums, function(item) {
          return _c(
            "div",
            { staticClass: "music_card" },
            [
              _c(
                ...
                [
                  ...
                  _c(
                    "div",
                    { staticClass: "card_author" },
                    [
                      _c(
                        "router-link",
                        {
                          attrs: {
                            to: { name: "artist", params: { id: item.author } }
                          }
                        },
                        [
                          _vm._v(
    ...
    _vm._v(" "),
    _c("div", { staticClass: "music_row" }, [
      _c("h4", { staticClass: "row_title" }, [_vm._v("Все альбомы")]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "row_cont" },
        _vm._l(_vm.albumsAll, function(item) {
          return _c(
            "div",
            { staticClass: "music_card" },
            [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "music_row" }, [
      _c("h4", { staticClass: "row_title" }, [_vm._v("Добрый вечер!")]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "row_cont", staticStyle: { "margin-top": "15px" } },
        [
          _c("div", { staticClass: "hi_block" }, [
            _c("div", { staticClass: "hi_img" }, [
              _c("img", {
                attrs: {
                  src:
                    "https://i.scdn.co/image/ab67616d0000b273b81442278960c6a7f21c800a",
                  alt: ""
                }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "hi_title" }, [
              _vm._v("Включив, ты станешь счастливым")
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "hi_block" }, [
            _c("div", { staticClass: "hi_img" }, [
              _c("img", {
                attrs: {
                  src:
                    "https://i.scdn.co/image/ab67706c0000da8484db0fb72ea9ca2980bb3d43",
                  alt: ""
                }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "hi_title" }, [_vm._v("Плейлист")])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "hi_block" }, [
            _c("div", { staticClass: "hi_img" }, [
              _c("img", {
                attrs: {
                  src:
                    "https://i.scdn.co/image/ab6761610000e5eb740f94ce25419fe7045236bb",
                  alt: ""
                }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "hi_title" }, [_vm._v("MORGENSHTERN")])
          ])
        ]
      ),
      _vm._v(" "),
      _c(
        ...
        {
          staticClass: "row_cont",
          staticStyle: { "margin-top": "17px", "margin-bottom": "15px" }
        },
        [
          _c("div", { staticClass: "hi_block" }, [
            _c("div", { staticClass: "hi_img" }, [
              _c("img", {
                attrs: {
                  src:
                    "https://i.scdn.co/image/3cffe518fd2708f1bd803e19e8f14c64f46cb958",
                  alt: ""
                }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "hi_title" }, [_vm._v("XXXTENTACION")])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "hi_block" }, [
            _c("div", { staticClass: "hi_img" }, [
              _c("img", {
                attrs: {
                  src:
                    "https://i.scdn.co/image/ab67616d0000b27355e74f47656c991c68045d85",
                  alt: ""
                }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "hi_title" }, [
              _vm._v("MILLION DOLLAR: Buisness")
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "hi_block" }, [
            _c("div", { staticClass: "hi_img" }, [
              _c("img", {
                attrs: {
                  src:
                    "https://i.scdn.co/image/ab6761610000e5eb924ba0710b8c09bec669708d",
                  alt: ""
                }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "hi_title" }, [_vm._v("FACE")])
          ])
        ]
      )
    ])
...
var render = function() {
  ...
  return _c("div", { staticStyle: { "padding-top": "60px" } }, [
    ...
    _c(
      "div",
      { staticClass: "music_row", staticStyle: { "margin-left": "25px" } },
      [
        _c("h4", { staticClass: "row_title" }, [_vm._v("Альбомы исполнителя")]),
        _vm._v(" "),
        _vm.albumAll
          ...
          : _c("div", [_c("i", { staticClass: "bi bi-clock" })])
      ]
    )
  ])
}
    ...
    _c(
      ...
      [
        _c(
          "div",
          {
            staticClass: "artist_img",
            staticStyle: { "margin-bottom": "23px", "margin-left": "15px" }
          },
          [
            _c("img", {
              staticStyle: {
              ...
              attrs: { id: "user_img_page", src: _vm.artist["image"], alt: "" }
            })
          ]
        ),
        _vm._v(" "),
        _c(
          ...
          [
            _c("div", { staticClass: "verify" }, [
              ...
              _vm._v(" "),
              _c("p", [_vm._v("Подтвержденный профиль")])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "artist_name" }, [
              _vm._v(
...
/* harmony import */ var _views_Album__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/Album */ "./resources/js/views/Album.vue");
/* harmony import */ var _views_Home__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/Home */ "./resources/js/views/Home.vue");
/* harmony import */ var _views_Artist__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/Artist */ "./resources/js/views/Artist.vue");
/* harmony import */ var _views_Search__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/Search */ "./resources/js/views/Search.vue");
/* harmony import */ var _views_Auth__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./views/Auth */ "./resources/js/views/Auth.vue");
/* harmony import */ var _views_Add__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/Add */ "./resources/js/views/Add.vue");
/* harmony import */ var _views_User__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./views/User */ "./resources/js/views/User.vue");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/search',
    name: 'search',
    component: _views_Search__WEBPACK_IMPORTED_MODULE_6__["default"]
  }, {
    path: '/add',
    name: 'add',
    component: _views_Add__WEBPACK_IMPORTED_MODULE_8__["default"]
  }, {
    path: '/auth',
    name: 'auth',
    component: _views_Auth__WEBPACK_IMPORTED_MODULE_7__["default"]
  }, {
    path: '/album:id',
    name: 'album',
    props: true,
    component: _views_Album__WEBPACK_IMPORTED_MODULE_3__["default"]
  }, {
    path: '/artist:id',
    name: 'artist',
    props: true,
    component: _views_Artist__WEBPACK_IMPORTED_MODULE_5__["default"]
  }, {
    path: '/user:id',
    name: 'user',
    props: true,
    component: _views_User__WEBPACK_IMPORTED_MODULE_9__["default"]
  }]
});
...
__webpack_require__(/*! D:\torrent\open_server_5_3_7_basic_full\OpenServer\domains\music\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\torrent\open_server_5_3_7_basic_full\OpenServer\domains\music\resources\sass\app.scss */"./resources/sass/app.scss");
